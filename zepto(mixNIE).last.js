    ...
    function(n) {
        ...
        if (o(n)) {
            ...
            for (var s in n) {
                ...
                if (!u(c)) {
                    ...
                    a.push(s + ":" + c),
                    t.push(s + "=" + encodeURIComponent(c)),
                    i.push(s + "[" + r + "]=" + encodeURIComponent(c))
                }
            }
        }
      ...
      , m = function(n) {
        if (e.report) {
            for (; r.length; ) {
                ...
                o || (e.combo ? l.push(i[0]) : f(e.report + i[2] + "&_t=" + +new Date),
                e.onReport && e.onReport(e.id, u))
            }
            var d = l.length;
            if (d) {
                var g = function() {
                    clearTimeout(p),
                    f(e.report + l.join("&") + "&count=" + d + "&_t=" + +new Date),
                    p = 0,
                    l = []
                };
      ...
      , d = {
        ...
        init: function(n) {
            ...
            return t && (/qq\.com$/gi.test(window.location.hostname) && (e.url || (e.url = "//badjs2.qq.com/badjs"),
            e.uin || (e.uin = parseInt((document.cookie.match(/\buin=\D+(\d+)/) || [])[1], 10))),
            e.report = e.url + "?id=" + t + "&uin=" + e.uin + "&from=" + encodeURIComponent(location.href) + "&ext=" + JSON.stringify(e.ext) + "&"),
            d
        },
...
function(n) {
    if (n.BJ_REPORT) {
        ...
        , o = function(n, r) {
            ...
            return function() {
                for (var r, e = [], t = 0, o = arguments.length; o > t; t++)
                    r = arguments[t],
                    u(r) && (r = i(r)),
                    e.push(r);
            ...
            return function(r, e) {
                ...
                return r = i(r, o.length && o),
                n(r, e)
            }
        }, c = function(n, r) {
            return function() {
                for (var e, t, o = [], a = 0, s = arguments.length; s > a; a++)
                    e = arguments[a],
                    u(e) && (t = i(e)) && (e.tryWrap = t) && (e = t),
                    o.push(e);
        ...
        t.spyJquery = function() {
            ...
            r.fn.on = c(e),
            r.fn.off = function() {
                for (var n, r = [], e = 0, t = arguments.length; t > e; e++)
                    n = arguments[e],
                    u(n) && n.tryWrap && (n = n.tryWrap),
                    r.push(n);
                return o.apply(this, r)
            }
            ) : window.jQuery && (e = r.event.add,
            o = r.event.remove,
            r.event.add = c(e),
        ...
        t.spyModules = function() {
            var r = n.require
              , e = n.define;
            return e && e.amd && r && (n.require = a(r),
            o(n.require, r),
            n.define = a(e),
            o(n.define, e)),
            n.seajs && e && (n.define = function() {
                for (var n, r = [], t = 0, o = arguments.length; o > t; t++)
                    n = arguments[t],
                    u(n) && (n = i(n),
            ...
            ,
            n.seajs.use = a(n.seajs.use),
            o(n.define, e)),
            t
        }
        ,
        t.spySystem = function() {
            return n.setTimeout = s(n.setTimeout),
            n.setInterval = s(n.setInterval),
            t
        }
        ,
        ...
        ,
        t.spyAll = function() {
            return t.spyJquery().spyModules().spySystem(),
            t
        }
    }
}(window),
...
var Zepto = function() {
    ...
    function h(t) {
        var e, n;
        return L[t] || (e = A.createElement(t),
...
function(t) {
    ...
    t.ajax = function(e) {
        ...
        w.overrideMimeType && w.overrideMimeType(g)),
        ...
        w.onreadystatechange = function() {
            if (4 == w.readyState) {
                ...
                if (w.status >= 200 && w.status < 300 || 304 == w.status || 0 == w.status && "file:" == b) {
                    ...
                    try {
                        "script" == u ? (1,
                        eval)(e) : "xml" == u ? e = w.responseXML : "json" == u && (e = S.test(e) ? null : t.parseJSON(e))
                    } catch (o) {
                        r = o
                    }
...
function(e) {
    e.extend(e, {
        makeArray: function(n, r) {
            var u, i = r || [];
            return null != n && (u = jQuery.type(n),
            null == n.length || "string" === u || "function" === u || "regexp" === u || jQuery.isWindow(n) ? i.push(n) : e.merge(i, n)),
            i
        }
    })
}(jQuery);
...
!function(t) {
    var e = function(t, e) {
      ...
      , u = function(t, o, r, a, u, s, c) {
        return t = n(t, n(n(i(o, r, a), u), c)),
        n(e(t, s), o)
    }
      , s = function(t, i, r, a, u, s, c) {
        return t = n(t, n(n(o(i, r, a), u), c)),
        n(e(t, s), i)
    }
      , c = function(t, i, o, a, u, s, c) {
        return t = n(t, n(n(r(i, o, a), u), c)),
        n(e(t, s), i)
    }
      , l = function(t, i, o, r, u, s, c) {
        return t = n(t, n(n(a(i, o, r), u), c)),
        n(e(t, s), i)
    }
      , f = function(t) {
        for (var e, n = t.length, i = n + 8, o = (i - i % 64) / 64, r = 16 * (o + 1), a = Array(r - 1), u = 0, s = 0; n > s; )
            e = (s - s % 4) / 4,
            u = s % 4 * 8,
            a[e] = a[e] | t.charCodeAt(s) << u,
            s++;
        return e = (s - s % 4) / 4,
        u = s % 4 * 8,
        a[e] = a[e] | 128 << u,
    ...
    t.extend(t, {
        md5: function(t) {
            var e, i, o, r, a, h, p, g, y, w = Array(), v = 7, x = 12, b = 17, _ = 22, j = 5, k = 9, S = 14, L = 20, q = 4, C = 11, z = 16, D = 23, T = 6, P = 10, E = 15, R = 21;
            for (t = d(t),
            w = f(t),
            h = 1732584193,
            p = 4023233417,
            ...
            e = 0; e < w.length; e += 16)
                ...
                r = g,
                a = y,
                h = u(h, p, g, y, w[e + 0], v, 3614090360),
                y = u(y, h, p, g, w[e + 1], x, 3905402710),
                g = u(g, y, h, p, w[e + 2], b, 606105819),
                p = u(p, g, y, h, w[e + 3], _, 3250441966),
                h = u(h, p, g, y, w[e + 4], v, 4118548399),
                y = u(y, h, p, g, w[e + 5], x, 1200080426),
                g = u(g, y, h, p, w[e + 6], b, 2821735955),
                p = u(p, g, y, h, w[e + 7], _, 4249261313),
                h = u(h, p, g, y, w[e + 8], v, 1770035416),
                y = u(y, h, p, g, w[e + 9], x, 2336552879),
                g = u(g, y, h, p, w[e + 10], b, 4294925233),
                p = u(p, g, y, h, w[e + 11], _, 2304563134),
                h = u(h, p, g, y, w[e + 12], v, 1804603682),
                y = u(y, h, p, g, w[e + 13], x, 4254626195),
                g = u(g, y, h, p, w[e + 14], b, 2792965006),
                p = u(p, g, y, h, w[e + 15], _, 1236535329),
                h = s(h, p, g, y, w[e + 1], j, 4129170786),
                y = s(y, h, p, g, w[e + 6], k, 3225465664),
                g = s(g, y, h, p, w[e + 11], S, 643717713),
                p = s(p, g, y, h, w[e + 0], L, 3921069994),
                h = s(h, p, g, y, w[e + 5], j, 3593408605),
                y = s(y, h, p, g, w[e + 10], k, 38016083),
                g = s(g, y, h, p, w[e + 15], S, 3634488961),
                p = s(p, g, y, h, w[e + 4], L, 3889429448),
                h = s(h, p, g, y, w[e + 9], j, 568446438),
                y = s(y, h, p, g, w[e + 14], k, 3275163606),
                g = s(g, y, h, p, w[e + 3], S, 4107603335),
                p = s(p, g, y, h, w[e + 8], L, 1163531501),
                h = s(h, p, g, y, w[e + 13], j, 2850285829),
                y = s(y, h, p, g, w[e + 2], k, 4243563512),
                g = s(g, y, h, p, w[e + 7], S, 1735328473),
                p = s(p, g, y, h, w[e + 12], L, 2368359562),
                h = c(h, p, g, y, w[e + 5], q, 4294588738),
                y = c(y, h, p, g, w[e + 8], C, 2272392833),
                g = c(g, y, h, p, w[e + 11], z, 1839030562),
                p = c(p, g, y, h, w[e + 14], D, 4259657740),
                h = c(h, p, g, y, w[e + 1], q, 2763975236),
                y = c(y, h, p, g, w[e + 4], C, 1272893353),
                g = c(g, y, h, p, w[e + 7], z, 4139469664),
                p = c(p, g, y, h, w[e + 10], D, 3200236656),
                h = c(h, p, g, y, w[e + 13], q, 681279174),
                y = c(y, h, p, g, w[e + 0], C, 3936430074),
                g = c(g, y, h, p, w[e + 3], z, 3572445317),
                p = c(p, g, y, h, w[e + 6], D, 76029189),
                h = c(h, p, g, y, w[e + 9], q, 3654602809),
                y = c(y, h, p, g, w[e + 12], C, 3873151461),
                g = c(g, y, h, p, w[e + 15], z, 530742520),
                p = c(p, g, y, h, w[e + 2], D, 3299628645),
                h = l(h, p, g, y, w[e + 0], T, 4096336452),
                y = l(y, h, p, g, w[e + 7], P, 1126891415),
                g = l(g, y, h, p, w[e + 14], E, 2878612391),
                p = l(p, g, y, h, w[e + 5], R, 4237533241),
                h = l(h, p, g, y, w[e + 12], T, 1700485571),
                y = l(y, h, p, g, w[e + 3], P, 2399980690),
                g = l(g, y, h, p, w[e + 10], E, 4293915773),
                p = l(p, g, y, h, w[e + 1], R, 2240044497),
                h = l(h, p, g, y, w[e + 8], T, 1873313359),
                y = l(y, h, p, g, w[e + 15], P, 4264355552),
                g = l(g, y, h, p, w[e + 6], E, 2734768916),
                p = l(p, g, y, h, w[e + 13], R, 1309151649),
                h = l(h, p, g, y, w[e + 4], T, 4149444226),
                y = l(y, h, p, g, w[e + 11], P, 3174756917),
                g = l(g, y, h, p, w[e + 2], E, 718787259),
                p = l(p, g, y, h, w[e + 9], R, 3951481745),
                h = n(h, i),
                p = n(p, o),
                g = n(g, r),
                y = n(y, a);
...
!function(t) {
    t.chainclude = function(e, n) {
        var i = function(o, r) {
            if ("undefined" != typeof e.length)
                return 0 == e.length ? t.isFunction(n) ? n(r) : null : (e.shift(),
    ...
    t.chainclude.load = function(e, n) {
        if ("object" == typeof e && "undefined" == typeof e.length)
            for (var i in e)
                return t.include.load(i, n, e[i].callback);
        e = t.makeArray(e),
...
!function() {
    nie.site = nie.site || function() {
        ...
        if (e)
            return o[e[1].substring(0, e[1].length - 1)] ? null : e[1].substring(0, e[1].length - 1).toLowerCase();
        if (/^(www\.)?(\u68a6\u5e7b\u897f\u6e38|xn--owt49tjseb46a)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(t))
            return "xyq";
        if (/^(www\.)?(\u98de\u98de|xn--q35aa)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(t))
            return "ff";
        if (/^(www\.)?(\u5927\u8bdd\u897f\u6e38|xn--pss230cs2tifc)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(t))
            return "xy2";
        if (i[t])
            return i[t];
        var r = /^((?:[^\.]+\.)+)([^\.]+)\.\w+/i.exec(t);
...
!function(t, e) {
    ...
    i.all = function(t) {
        ...
        return i(function(e, n) {
            ...
            for (var a = 0, u = [], s = t.length, c = s; s > a; a++)
                t[a].then(i(a), o)
        })
    }
    ,
...
!function($) {
    function unique(t) {
        for (var e, n = [], i = {}, o = 0; null != (e = t[o]); o++)
            i[e] || (n.push(e),
            i[e] = !0);
        return n
    }
    ...
    function factoryProcess(t) {
        ...
        return 0 >= t ? (e(t),
        !0) : _factoryList[t - 1].did ? (e(t),
        !0) : (_factoryList[t].canProcess = !0,
        !1)
    }
    ...
    nie.define = function(t, e) {
        ...
        var n = e.toString().match(/nie\.require\([^\)]+\)/g)
          , i = ""
          , o = 0;
        if (t && (_defineList[t] = !0),
        !n || !n.length)
            return factoryProcess(e.__nieIndex);
        for (var r = 0; r < n.length; r++)
            n[r] = n[r].match(/\(([^\)]+)\)/i)[1].replace(/'|"/g, "");
        if (n = unique(n),
        n = filter(n, function(t) {
    ...
    nie.pack = function(t) {
        ...
        i = 0; i < t.length; i++)
            e += t[i].replace(/\./g, "/") + ".js,",
            _verHash[t[i]] && (n += _verHash[t[i]]);
        return e = _host + "??" + e + "v=" + n + ".js",
    ...
    nie.config = nie.config || {
        ...
        stats: {
            ...
            url: {
                ...
                _cb: function() {
                    for (var t = nie.config.stats.url._data, e = 0, n = t.length; n > e; e++)
                        nie.config.stats.url._run(t[e].url, t[e].title, t[e].site)
                },
                _run: function(e, n, i) {
...
nie.util.addStyle = function(t) {
    var e;
    document.all ? (e = document.createStyleSheet(),
    e.cssText = t) : (e = document.createElement("style"),
    e.type = "text/css",
    e.textContent = t);
    try {
...
nie.util.ajax = function(t) {
    ...
    return "127.0.0.1" != e && "locahost" != e && "test.nie.163.com" != e && 0 != e.indexOf("10.") && 0 != e.indexOf("192.") && e.indexOf("test.nie.163.com") < 0 ? $.ajax(t) : (url = t.url.replace(/#\S*/gi, ""),
    void $.ajax({
        type: "get",
    ...
    nie.util.stats = function() {
        ...
        if (null == nie.config.stats.id) {
            if (null != nie.config.site)
                if ("undefined" != typeof e[nie.config.site])
                    n = i(nie.config.site);
                else {
...
var LocalData = {
    ...
    remove: function(t) {
        this.isLocalStorage ? localStorage.removeItem(t) : this.initDom() && (this.dataDom.load(this.hname),
        this.dataDom.removeAttribute(t),
        this.dataDom.save(this.hname))
    }
}
  , __GetScript = function(t) {
    function e(t) {
        ...
        var r = o.onerror = function(e) {
            ...
            window.random = null,
            void ("undefined" != typeof BJ_REPORT && BJ_REPORT.report(1 == e ? "[" + nie.site + "][adconfig_error][timeout][data:" + t.data + "]" : "[" + nie.site + "][adconfig_error][interface_error][data:" + t.data + "]"))) : !1
        }
        ;
        window[e] = function() {
            if (!i)
    ...
    function n(e) {
        ...
        t.ajax({
            ...
            error: function(n, i, o) {
                return "yys" != nie.site ? e.error() : (BJ_REPORT.report("[" + nie.site + "][adconfig_ajax_error][data:" + e.data + "][status:" + i + "][error:" + o + "][msg:" + n.responseText + "]"),
                void (("abort" == i || "timeout" == i) && t.ajax({
  ...
  , ADBase = function(t) {
    ...
    function n(t) {
        for (var e = [], n = [], o = !!t[0].noCache, r = t[0].time || 15e3, u = (new Date,
        0); u < t.length; u++)
            e.push(t[u].pos),
            n.push(t[u].callback);
        e = e.join(","),
        f({
            ...
            success: function(t) {
                if (t.succ && "00" == t.result.code) {
                    ...
                    a(e, n),
                    "undefined" != typeof BJ_REPORT && BJ_REPORT.report("[" + l.site + "][adconfig_error][interface_fail][data:" + m.stringify(t) + "]")
            },
            error: function() {
                a(e, n)
            }
    ...
    function r(t, e) {
        for (var n in e)
            !t[n] || t[n].length < 1 ? t[n] = e[n] : t[n] && t[n].length && e[n] && e[n].length ? t[n] = e[n] : t[n] && t[n].length && (!e[n] || e[n].length < 1) ? t[n] = [] : (!e[n] || e[n].length < 1) && (!t[n] || t[n].length < 1) && (t[n] = []);
        return t
    }
    function a(t, e) {
        var n = d.get(t);
...
!function(t) {
    nie.util.union = nie.util.union || {
        ...
        processUrl: function() {
            ...
            if (t.inArray(this.url.raw, this.unionFabUrlList) >= 0)
                this.url.isUnion = !0,
